...
function createPieceQueryNumber(number) {
    switch(buttonClicked.id) {
        ...
        case 'canzonas-btn':
            if (number == 1) {
                return `<div id="total-found">${number} violin canzona found since ${savedDate}</div>`
                break;
            }
            return `<div id="total-found">${number} violin canzonas found since ${savedDate}</div>`
            break;
        case 'nocturnes-btn':
            if (number == 1) {
                return `<div id="total-found">${number} violin nocturne found since ${savedDate}</div>`
                break;
            }
